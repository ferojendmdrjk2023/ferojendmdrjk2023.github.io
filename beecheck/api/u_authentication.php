...
$db->q("SELECT * FROM tbl_user WHERE user_name = '".$username."' ");
...
if (count($checkusernamepass) > 0) {
    ...
    // not exist
    echo '<script>alert("User is not found, please re-enter or SIGN UP");location.replace("../pages/signup.php");</script>';
}
