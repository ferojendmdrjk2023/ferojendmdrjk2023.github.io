...
CREATE TABLE `tbl_quiz` (
  ...
  `quiz_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `made_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
(55,	'../images/image026.jpg',	'AIGen-Art',	4000),
(56,	'../images/image26.jpg',	'AIGen-Art',	4000),
...
CREATE TABLE `tbl_user` (
  ...
  `pic_pro` varchar(255) DEFAULT NULL,
  `cmltv_score` decimal(6,2) DEFAULT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO `tbl_user` (`user_id`, `user_name`, `email`, `password`, `pic_pro`, `cmltv_score`) VALUES
(1,	'Usagi001',	'usagi001@gmail.com',	'Password01#',	NULL,	400.00),
(3,	'james',	'updatejames mail',	'Password01#',	NULL,	3000.00),
(4,	'raymond',	'raymondred@whatever.com',	'password01',	NULL,	600.00),
(5,	'bernice',	'bernice@gmail.com',	'password01',	NULL,	1400.00),
(6,	'vania',	'vania@gmail.com',	'password01',	NULL,	2500.00),
(7,	'taylor1989',	'taylor1989@taylorswift.com',	'password01',	NULL,	0.00),
(8,	'sandra',	'sandra@gmail.com',	'password01',	NULL,	0.00),
(10,	'clarabow',	'clarabow@gmail.com',	'password01',	NULL,	0.00),
(11,	'betty001',	'betty001@gmail.com',	'password01',	NULL,	0.00),
(12,	'dorothea001',	'dorothea001@outlook.com',	'password01',	NULL,	0.00),
(13,	'marjorie001',	'marjorie001@gmail.com',	'password01',	NULL,	0.00),
(15,	'aimee002',	'aimee002@outlook.com',	'password01',	NULL,	0.00),
(17,	'leonardo',	'leonardo@decaprio.com',	'Password',	NULL,	0.00),
(18,	'Gabriella',	'Gabriella123@gmail.com',	'Password02#',	NULL,	0.00),
(19,	'Winnie',	'Winnie@gmail.com',	'Password01#',	NULL,	0.00),
(31,	'Alexa',	'Alexa123@gmail.com',	'Password01#',	NULL,	0.00),
(34,	'Viona',	'Viona123@gmail.com',	'Password01#',	NULL,	0.00),
(37,	'Lindsay',	'Lindsay001@gmail.com',	'Password01#',	NULL,	0.00),
(39,	'test009',	'test009@live.com',	'Password01#',	'',	0.00),
(40,	'test009',	'test009@live.com',	'Password01#',	'',	0.00),
(41,	'test0092',	'test0092@live.com',	'Password01#',	'',	0.00);
