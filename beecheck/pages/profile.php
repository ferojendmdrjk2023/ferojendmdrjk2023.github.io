...
<main>
        <div id="left_logo">
                ...
                <div class="exit-btn">
                        <button type="button" onclick="location.replace('../api/u_logout.php?_=<?php echo $row['user_id']; ?>');" class="button">LOG OUT</button>
                </div> 
        </div>  
                ...
                <div class="userprofile">
                    ...
                    <div class="profile-btn-cont">
                        <div class="profile-btn" style="margin-top: 150px";>
                            <button type="button" onclick="location.replace('../api/u_delprof.php?_=<?php echo $row['user_id']; ?>' )"class="button">DELETE ACCOUNT</button>
                            <button type="submit" formaction="../api/u_updateprof.php" class="button">UPDATE PROFILE</button>
