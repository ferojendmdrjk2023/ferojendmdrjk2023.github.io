...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validatePassword() {
        ...
        return lengthCheck.checked && uppercaseCheck.checked && numberCheck.checked && specialCheck.checked;
    }
    ...
    form.addEventListener('submit', function(event) {
        let isValid = validatePassword() && validateConfirmPassword();

        if (!isValid) {
            event.preventDefault();  // Prevent form submission if validation fails
            errorMessage.textContent = 'Please ensure passwords match and meet all requirements.';
        } else {
            errorMessage.textContent = '';  // Clear error message if form is valid
        }
    });

    passwordInput.addEventListener('input', function() {
        validatePassword();
        validateConfirmPassword(); // Validate both on password input
    });
    ...
    validatePassword(); // Initial password validation
});
