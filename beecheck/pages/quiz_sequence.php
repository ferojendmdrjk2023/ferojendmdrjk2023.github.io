        ...
        <div id="side">
            <section class="user-point-form" id="point">
                <form id="pointForm">
                    ...
                    <div class="icon">
                        <?php 
                        if(isset($_GET["isTrue"]) && !empty($_GET["isTrue"])) {
                            if ($_GET["isTrue"] == 1) { echo "<img src='../assets/true.png' alt='great'>";}
                            else if ($_GET["isTrue"] == 2) { echo "<img src='../assets/false.png' alt='opps'>"; } 
                            }
                        ?>
                    </div>
